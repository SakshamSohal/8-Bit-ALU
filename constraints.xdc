...
set_property PACKAGE_PIN T16 [get_ports {Opcode[0]}]
set_property PACKAGE_PIN R10 [get_ports {Opcode[1]}]
set_property PACKAGE_PIN K17 [get_ports {Opcode[2]}]
...
set_property PACKAGE_PIN T15 [get_ports Zero]
